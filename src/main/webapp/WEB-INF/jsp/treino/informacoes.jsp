						...
						<div class="box box-primary">
							<div class="box-body">
								...
								<form:form role="form">
											...
											<c:forEach items="${treinos}" var="treino">
												<c:if test="${treino.active}">
													<tr>
														...
														<td><a
															href="${pageContext.request.contextPath}/treino/pessoa/${treino.idTreino}">
																<i class="btn btn-primary">Exercicios</i>
														</a></td>
														<td><a
														...
														<td>
															<form method="post" action="/treino/ativar/">
																...
																<input type="hidden" name="ativo" value="false" /> <input
																	type="hidden" name="id" value="${treino.idTreino}" />
																<i><input class="btn btn-primary" type="submit"
																	value="Remover" /></i>
															</form>
														</td>
													</tr>
									...
									<a href="${pageContext.request.contextPath}/treino/criar">
										<i class="glyphicon glyphicon-edit"></i> Novo Treino
									</a>
									<c:forEach items="${treinos}" var="treino">
										<c:set var="idAluno" value="${treino.pessoa.idPessoa}" />
									</c:forEach>
									<a href="/historicotreinos/pessoa/${idAluno}"> <i
											class="fa fa-fw fa-user-plus"></i> <span>Histórico
												Treinos</span>
									</a>
								</form:form>
