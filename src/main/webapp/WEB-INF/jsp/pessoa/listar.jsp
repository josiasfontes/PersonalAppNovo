						...
						<div class="box box-primary">
							<div class="box-body">
												...
												<tr>
													...
													<td><a
														href="${pageContext.request.contextPath}/mensalidades/pessoa/${pessoa.idPessoa}">
															<i class="glyphicon glyphicon-edit"></i>Gerenciar Mensalidade
													</a></td>
													<td><a
														href="${pageContext.request.contextPath}/treinos/pessoa/${pessoa.idPessoa}">
															<i class="glyphicon glyphicon-edit"></i>Gerenciar Treino
													</a></td>
													<td>
														<form method="post" action="/pessoa/ativar/">
															<input type="hidden" name="ativo" value="false" /> <input
																type="hidden" name="id" value="${pessoa.idPessoa}" /> <i><input
																class="btn btn-primary" type="submit" value="Remover" /></i>
														</form>
								...
								<div class="box-footer clearfix">
									<a href="/pessoa/criar"> <i class="fa fa-fw fa-user-plus"></i>
